        ...
        <div className="flex justify-evenly font-mono bg-green-300 py-32 w-full h-[69vh]">
          <Link className="w-1/3" href="/user">
            ...
            <div className="relative flex items-center justify-center h-96 w-96 bg-gradient-to-br from-yellow-200 via-yellow-500 to-yellow-300 shadow-lg rounded-full border-8 border-yellow-500 hover:-translate-y-2 hover:shadow-xl">
              ...
              <div className="h-32 w-32 relative flex items-center justify-center">
                ...
                {/* Stem */}
                <div className="absolute h-2/3 w-1/12 rotate-6 bg-green-600 rounded-br-lg -bottom-1/2 left-1/2 transform -translate-x-1/2"></div>
              </div>
            </div>
          </Link>
          ...
          <Link className="w-1/3" href="/organizer">
            ...
            <div className="relative w-96 h-96  bg-gray-800 rounded-full z-10">
              {/* The gold coins */}
              <div className="rounded-full h-8 w-8 bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-300 shadow-lg border-4 border-yellow-400 absolute -top-4 left-[75%]"></div>
              <div className="rounded-full h-8 w-8 bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-300 shadow-lg border-4 border-yellow-400 absolute -top-4 left-[50%]"></div>
              {/* Gold coin 1 container */}
              <div className="relative">
                {/* Gold Coin */}
                <div className="rounded-full h-12 w-12 bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-300 shadow-lg border-4 border-yellow-400 absolute -top-4 left-[25%]"></div>
                {/* Four Leaf Clover */}
